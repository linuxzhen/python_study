...
update=rrdtool.updatev('./flow.rrd','%s:%s:%s' % (str(starttime),str(total_input_traffic),str(total_output_traffic)))  
print update
print starttime,total_input_traffic, total_output_traffic
